  ...
  return <>
    ...
    >
      ...
      <div className="p-[0_40px] flex-1 flex flex-col overflow-hidden">
        <div className="flex min-h-[400px] border-[#ced4da] border-b">
          <div className="w-1/3  m-auto">
            {project.src && <img className="w-[100%] align-middle" src={`${project.src}/logo.png`} />}
          </div>
          <div className="w-2/3 p-[20px_60px] m-auto">
            ...
            <div className="flex flex-col gap-[10px]">
              ...
              {project.github && <div className="flex">
                <div className="w-[80px] flex">
                  <img className="w-[16px] h-[20px] m-[auto_0] mr-[5px]" src="/icons/github.svg" alt="double arrow 아이콘" />
                  <span className="m-[auto_0]">코드</span>
                </div>
                <a href={project.github} className="text-[#2196F3]" target="_blank">
                  {project.github}
                </a>
              </div>}
              {project.link && <div className="flex">
                <div className="w-[80px] flex">
                  <img className="w-[16px] h-[16px] m-[auto_0] mr-[5px]" src="/icons/link.svg" alt="double arrow 아이콘" />
                  <span className="m-[auto_0]">링크</span>
                </div>
                <a href={project.link} className="text-[#2196F3]" target="_blank">
                  {project.link}
                </a>
              </div>}
            </div>
        ...
        <div style={{ scrollbarWidth: 'none' }} className="p-[40px_60px] overflow-auto scroll flex-1">
